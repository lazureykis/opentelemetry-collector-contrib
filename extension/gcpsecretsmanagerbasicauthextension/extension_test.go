...
func newExtensionWithPoller(t *testing.T, username, password string) *gcpSecretsManagerBasicAuth {
	t.Helper()
	mock := &mockGCPClient{payload: newGCPMockOutput(username, password)}
	...
	return &gcpSecretsManagerBasicAuth{
		cfg:    &Config{SecretName: "projects/my-project/secrets/my-creds/versions/latest"},
		poller: poller,
...
func TestExtension_AuthMethodsBeforeStart(t *testing.T) {
	ext := newExtension(&Config{SecretName: "projects/my-project/secrets/my-creds/versions/latest"}, zaptest.NewLogger(t))
...
func TestFactory_CreateExtension(t *testing.T) {
	...
	cfg.SecretName = "projects/my-project/secrets/my-creds/versions/latest"
